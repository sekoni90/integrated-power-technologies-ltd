        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold mb-2">
              <span className="text-blue-600">Create</span> <span className="text-yellow-400">Account</span>
            </h1>
            <p className="text-gray-600">Join us and start shopping for UPS solutions</p>
          </div>
